...
GameStates.makePreloader = function( game ) {
    ...
    return {
        ...
        preload: function () {
            ...
            game.load.image('WoodFloor','assets/Wood1.png');
            game.load.image('Metal', 'assets/Metal.png');
            game.load.image('Wasteland', 'assets/Wasteland.png');
            game.load.image('Dirt','assets/Dirt1.png');
            game.load.image('Camp','assets/Tent.png');
            game.load.image('CampWall','assets/TentWall.png');
            ...
            game.load.audio('Rock',['assets/rock.mp3']);
            game.load.audio('Wood',['assets/wood.mp3']);
            game.load.audio('Slash', ['assets/Slash2.m4a']);
            game.load.audio('Hammer',['assets/Hammer.m4a']);
        ...
        update: function () {
            ...
            if (game.cache.isSoundDecoded('GameOver') && game.cache.isSoundDecoded('Hammer') && game.cache.isSoundDecoded('Slash') && game.cache.isSoundDecoded('Wood') && game.cache.isSoundDecoded('Rock') && game.cache.isSoundDecoded('Win') && game.cache.isSoundDecoded('Boss') &&game.cache.isSoundDecoded('Gathering') && game.cache.isSoundDecoded('Crafting') && game.cache.isSoundDecoded('Adventure') && ready == false)
            {
                ready = true;
