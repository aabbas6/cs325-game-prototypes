...
GameStates.makePreloader = function( game ) {
    ...
    return {
        ...
        update: function () {
            ...
            // game.cache.isSoundDecoded('Gathering') && game.cache.isSoundDecoded('Crafting') && game.cache.isSoundDecoded('Adventure') &&
            if( game.cache.isSoundDecoded('Gathering') && ready==false)
            {
                ready = true;
